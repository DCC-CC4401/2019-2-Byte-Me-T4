...
/*
 * Returns the last index.html at which a given value can be found in an array, or `-1` if it's not
 * present. The array is searched backwards.
 * @private
 * @param {Array} array Array to search.
 * @param {*} value Value to locate in the array.
 * @returns {Number} Last zero-based index.html at which the item is found, or -1.
 */
 ...
 *   <li>The match array, with named backreference properties.
 *   <li>The zero-based match index.html.
 ...
 *     <li>The zero-based index.html of the match within the total search string.
